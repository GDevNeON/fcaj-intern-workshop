...
| **Amazon ECS**                      | Container Orchestration        | Quản lý cụm máy chủ ảo (Cluster) chạy ứng dụng theo dạng Fargate launch type.                                                                             |
...
| **Amazon ECS & NAT Gateway**        | Chạy cụm container (Fargate) kết hợp NAT Gateways hoạt động liên tục | **$10.00 - $20.00**               | Quản lý cụm máy chủ ảo chạy ứng dụng và định tuyến mạng.                                                                                                       |
